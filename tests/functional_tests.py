...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_can_start_A_list_And_retrieve_later(self):
        ...
        #validation framework, flask-wtf provides flask validation and it provides this CSRF protection
        ...
        time.sleep(2)
        self.check_for_row_in_list_table('1: Buy peacock feathers')
        self.check_for_row_in_list_table('2: use peacock feather to make hen')
        """self.assertTrue(
